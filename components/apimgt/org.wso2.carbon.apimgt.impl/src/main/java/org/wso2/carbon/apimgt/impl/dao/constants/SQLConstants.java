...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_LIGHT_WEIGHT_API_INFO_BY_API_IDENTIFIER = "SELECT API_ID,API_UUID,API_PROVIDER," +
            "API_NAME,API_VERSION,CONTEXT,CONTEXT_TEMPLATE,API_TYPE,STATUS FROM AM_API WHERE API_PROVIDER = ? AND " +
            "API_NAME = ? AND API_VERSION = ? AND ORGANIZATION = ?";
    ...
    public static final String ADD_API_PRODUCT =
            "INSERT INTO "
            + "AM_API(API_PROVIDER, API_NAME, API_VERSION, CONTEXT, CONTEXT_TEMPLATE,"
